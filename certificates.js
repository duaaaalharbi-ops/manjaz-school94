window.MANJAZ_CERTIFICATES_RUNTIME_VERSION = "10.7.7-large-type";
(function(){
  "use strict";
  ...
  function injectStyle(){
    ...
    link.rel="stylesheet"; link.href="certificates.css?v=10.7.7"; link.dataset.certificatesStyle="1";
  ...
  function renderCertificate(w,name){
    ...
    paper.innerHTML=`
      ...
      <main class="cert-final-main">
        ...
        <div class="cert-final-attendance">قد حضرت الورشة التدريبية بعنوان «${workshopTitle}»، والتي نُفذت يوم ${date}، بواقع ${durationPhrase}</div>
        <div class="cert-final-wish">متمنين لها دوام التوفيق ومزيدًا من التميز والعطاء</div>
        ${implementersBlock(w)}
      </main>

      <footer class="cert-final-footer">
        <div class="cert-final-date"><strong>تاريخ التحرير</strong><span>${esc(today)}</span></div>
        <div class="cert-final-stamp"><img src="official-school-stamp.png" alt="الختم الرسمي للمدرسة"></div>
        <div class="cert-final-principal"><strong>مديرة المدرسة</strong><span>زينب ناصر حكمي</span></div>
      </footer>`;
  }
