window.MANJAZ_CERTIFICATES_RUNTIME_VERSION = "10.7.12-verified-layout";
(function(){
  "use strict";
  ...
  function injectStyle(){
    ...
    link.rel="stylesheet"; link.href="certificates.css?v=10.7.12"; link.dataset.certificatesStyle="1";
  ...
  function renderCertificate(w,name){
    ...
    paper.innerHTML=`
      ...
      <footer class="cert-final-footer">
        <div class="cert-final-principal"><strong>مديرة المدرسة</strong><span>زينب ناصر علي</span><span>حكمي</span></div>
