window.MANJAZ_CERTIFICATES_RUNTIME_VERSION = "10.7.9-date-footer-name";
(function(){
  "use strict";
  ...
  function injectStyle(){
    ...
    link.rel="stylesheet"; link.href="certificates.css?v=10.7.9"; link.dataset.certificatesStyle="1";
  ...
  function renderCertificate(w,name){
    ...
    paper.innerHTML=`
      ...
      <div class="cert-final-date-line">تاريخ التحرير: ${dateSpan(today)}</div>`;
  }
